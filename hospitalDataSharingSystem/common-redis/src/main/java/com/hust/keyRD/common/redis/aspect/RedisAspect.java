package com.hust.keyRD.common.redis.aspect;

import com.hust.keyRD.common.redis.annotation.RedisCache;
import com.hust.keyRD.common.redis.annotation.RedisEvict;
import com.hust.keyRD.common.redis.util.RedisUtils;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.hust.keyRD.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.hust.keyRD.common.redis.annotation.RedisEvict)")

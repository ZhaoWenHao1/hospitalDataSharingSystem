...
public class DCPABEToolTest {
    ...
    public void testDecryptWorks() throws Exception {
        ...
        // 解密 输入：全局变量gpFile  用户名  加密文件  用户属性凭证

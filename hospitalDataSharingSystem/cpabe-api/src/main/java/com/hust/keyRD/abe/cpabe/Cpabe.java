package com.hust.keyRD.abe.cpabe;
import com.hust.keyRD.abe.cpabe.policy.LangPolicy;
...
import com.hust.keyRD.abe.bswabe.Bswabe;
import com.hust.keyRD.abe.bswabe.BswabeCph;
import com.hust.keyRD.abe.bswabe.BswabeCphKey;
import com.hust.keyRD.abe.bswabe.BswabeElementBoolean;
import com.hust.keyRD.abe.bswabe.BswabeMsk;
import com.hust.keyRD.abe.bswabe.BswabePrv;
import com.hust.keyRD.abe.bswabe.BswabePub;
import com.hust.keyRD.abe.bswabe.SerializeUtils;
...
public class Cpabe {
	...
	public byte[] enc(String pubfile, String policy, byte[] input_plt) throws Exception {
		BswabePub pub;
		BswabeCph cph;
		BswabeCphKey keyCph;
		byte[] plt;
		...
		plt = input_plt;
		return AESCoder.encrypt(m.toBytes(), plt);
